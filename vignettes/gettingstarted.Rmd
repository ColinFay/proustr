...
vignette: >
  %\VignetteIndexEntry{Getting started with proustr}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

## Tools for NLP in French and texts from Marcel Proust's collection "A La Recherche Du Temps Perdu"

TThis package gives you access to tools designed to do NLP in French. You can use these tools with the books from Marcel Proust "À la recherche du temps perdu", which are provided in this package. Of course, these tools can be expanded to almost all french texts. 
